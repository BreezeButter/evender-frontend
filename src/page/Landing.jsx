                ...
                <div className="absolute top-60 left-32">
                    <div className="">
                        ...
                        <p className="w-[36%] text-lg text-gray-100 font-light mt-12">
                            ...
                            people who share it on Evender. Events are happening
                            every day
                        </p>
                    ...
                    <div className="flex justify-center ">
                        <div className="w-[52%]">
                            ...
                            <p className="text-center text-darkbluecute text-lg font-normal mb-20">
                                It’s easy to quickly make new friends. There are
                                more than 60 million people on Evender looking
                                to gather over shared interests and hobbies,
                                build professional networks, or just have some
                                fun.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-row h-[500px]">
                    ...
                    <div className="flex flex-col justify-center p-36 w-[50%]">
                        ...
                        <p className="text-darkbluecute font-normal text-base mt-8 mb-16 w-[88%]">
                            ...
                            share them. Lasting connections are made on Evender.
                        </p>
